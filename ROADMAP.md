...
- [ ] W2.1 Define the panel buffer mode (`emacs-jupyter-notebook-panel-mode`,
      ...
      (no kernel).
- [ ] W2.2 Implement the latest-per-cell view as the default. Cell key is
...
- [ ] W2.3 Implement the history-log view. Toggle via `H` in the panel.
...
- [ ] W2.6 Navigation keys: `q`, `RET`, `n`, `p`. ERT: `RET` on a section
