...
OPS = {"hello", "ping", "grant_event_credit", "connect", "suspend", "resume", "kernel_info", "execute", "complete", "inspect", "variables", "is_complete", "input_reply", "interrupt", "shutdown", "close"}
...
NO_PARAMS = {"ping", "suspend", "resume", "kernel_info", "interrupt", "shutdown", "close"}
